...
import 'package:mova/app/modules/movie_detail/controllers/movie_detail_controller.dart';
...
class MovieCommentController extends GetxController {
  late TextEditingController comment;
  final loading = false.obs;

  final modelC = Get.find<ModelController>();
  final movieC = Get.find<MovieDetailController>();
    ...
    if(isConnect){
      try{
        ...
        if(response.statusCode == 200){
          ...
          await movieC.getMovieDetail(context, filmId);
        }else{
