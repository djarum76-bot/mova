...
import 'package:mova/app/modules/movie_comment/controllers/movie_comment_controller.dart';
...
class MovieCommentView extends GetView<MovieCommentController> {
  const MovieCommentView({Key? key}) : super(key: key);
