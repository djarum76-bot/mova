...
class RegisterView extends GetView<RegisterController> {
      ...
      return TextFormField(
        ...
        decoration: InputDecoration(
            ...
            suffixIcon: IconButton(
                ...
                icon: Icon(controller.secure.value ? Icons
        ...
        keyboardAppearance: Brightness.dark,
        validator: ValidationBuilder().minLength(8, "Password minimum 8 letters").build(),
      );
    });
  }
  ...
  Widget _loadingOrSignUp(BuildContext context){
    return SizedBox(
      width: Get.width,
  ...
  Widget _signUpButton(BuildContext context){
    return AppButton(
        onPressed: () {
          controller.passwordRegisterToFirebase(context);
        },
        child: AutoSizeText(
          "Sign up",
          style: GoogleFonts.urbanist(
